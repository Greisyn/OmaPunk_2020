...
BarWidget {
  ...
  readonly property var sheetService: bar && bar.shell ? bar.shell.serviceFor("local.cyberpunk-sheet") : null
  ...
  WidgetButton {
    ...
    tooltipText: (root.charName !== "" ? root.charName : "Cyberpunk Sheet") + "\nLeft click: toggle sheet\nRight click: settings"
    ...
    onPressed: function(b) {
      ...
      if (b === Qt.LeftButton) {
        Quickshell.execDetached(["omarchy-shell", "local.cyberpunk-sheet", "toggle"]);
      }
    }
  }
}
