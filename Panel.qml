...
Panel {
  id: root
  moduleName: "local.cyberpunk-sheet"
  ipcTarget: "local.cyberpunk-sheet-panel"
  manageIpc: false
    ...
    Flickable {
      ...
      Column {
        ...
        Row {
          ...
          WidgetButton { text: "Show"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.cyberpunk-sheet", "show"]); } }
          WidgetButton { text: "Hide"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.cyberpunk-sheet", "hide"]); } }
          WidgetButton { text: "Toggle"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.cyberpunk-sheet", "toggle"]); } }
          WidgetButton { text: "Export"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.cyberpunk-sheet", "exportSheet"]); } }
        }
        ...
        RowLabel { width: parent.width; wrapMode: Text.WordWrap; text: "Exports are named per character (<Handle>.txt), so each character gets its own file." }
        TextField {
          width: parent.width
        ...
        Row {
          width: parent.width; spacing: Style.spacing.sm
          WidgetButton { text: "Export now"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.cyberpunk-sheet", "exportSheet"]); } }
